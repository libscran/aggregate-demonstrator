...
RcppExport SEXP _demo_aggregate_across_cells(SEXP xSEXP, SEXP groupingsSEXP, SEXP nthreadsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_demo_aggregate_across_cells", (DL_FUNC) &_demo_aggregate_across_cells, 3},
    {NULL, NULL, 0}
};
